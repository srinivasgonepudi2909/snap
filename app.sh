      ...
      <nav className="px-6 py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            ...
            <Link to="/signup" className="px-6 py-2 bg-gradient-to-r from-red-600 to-red-800 text-white rounded-lg hover:scale-105 transition-transform">
              Sign Up
            </Link>
          </div>
        </div>
    ...
    <div className="px-6 py-20">
      <div className="max-w-7xl mx-auto text-center">
        <h1 className="text-6xl font-bold mb-6 text-white">
          Your Digital Vault
          <span className="block text-5xl bg-gradient-to-r from-red-400 to-red-600 bg-clip-text text-transparent">
            Secured & Organized
          </span>
        </h1>
        ...
        <Link to="/signup" className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-red-600 to-red-800 text-white text-lg font-semibold rounded-xl hover:scale-105 transition-transform">
          Get Started Free
    ...
    <div className="px-6 py-20">
      <div className="max-w-7xl mx-auto text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link to="/signup" className="px-8 py-4 bg-gradient-to-r from-red-600 to-red-800 text-white text-lg font-semibold rounded-xl hover:scale-105 transition-transform">
            Start Free Trial
          </Link>
